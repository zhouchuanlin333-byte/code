...
# 保存验证图
plt.tight_layout()
plt.savefig('修复后的_到市中心距离_pdp验证图.png', dpi=300)
plt.close()
...
# 保存对比图
plt.tight_layout()
plt.savefig('到市中心距离_实际数据与PDP对比图.png', dpi=300)
plt.close()

print("\n✅ 验证完成！修复后的PDP图现在正确显示了真实的距离范围。")
print("   生成的验证图:")
print("   - 修复后的_到市中心距离_pdp验证图.png")
print("   - 到市中心距离_实际数据与PDP对比图.png")
